...
export function LampEffect({ className }: LampEffectProps) {
  return (
    <div className={cn("absolute top-0 isolate z-0 flex w-full flex-1 items-start justify-center", className)}>
      ...
      {/* Main glow */}
      <div className="absolute inset-auto z-50 h-56 w-[40rem] -translate-y-[-30%] rounded-full bg-green-500/50 opacity-80 blur-[100px]" />
      ...
      <motion.div
        ...
        className="absolute inset-auto right-1/2 h-72 overflow-visible w-[40rem] bg-gradient-conic from-green-500/50 via-transparent to-transparent [--conic-position:from_70deg_at_center_top]"
      >
      ...
      <motion.div
        ...
        className="absolute inset-auto left-1/2 h-72 w-[40rem] bg-gradient-conic from-transparent via-transparent to-green-500/50 [--conic-position:from_290deg_at_center_top]"
      >
